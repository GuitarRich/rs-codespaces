...
type AlternateNavigationProps = {
    params: { [key: string]: string };
    fields: Fields;
};

type AlternateNavigationItemProps = {
    key: string;
    index: number;
    total: number;
    field: LinkField;
...
const AlternateNavigationItem = (props: AlternateNavigationItemProps) => {
...
export const Default = (props: AlternateNavigationProps): JSX.Element => {
